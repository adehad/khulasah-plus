  ...
  new WirdModel("Ratib Imam Al-Haddad", [
    ...
    new DhikrModel("", [
      new DhikrEntryModel({
        ...
        translit: "Aṣlaḥallāhu umūral muslimīn, ṣarafallāhu sharral mu’dhīn.",
        repeat: 3,
      }),
    ]),
    new DhikrModel("", [
    ...
    new DhikrModel("", [
      ...
      new DhikrEntryModel({
        ...
        translit: " wa ilā rūḥi sayyidinal muhājiri ilallāhi Aḥmadabni ‛Īsā ",
      }),
      new DhikrEntryModel({
      ...
      new DhikrEntryModel({
        arabic: " وَيُعِيدُ عَلَيْنَا مِنْ بَرَكَاتِهِم وَأَسْرَارِهِمْ وَأَنْوَارِهِمْ وَعُلُومِهِم وَنَفَحَاتِهِم ",
        translation:
    ...
    new DhikrModel("", [
      ...
      new DhikrEntryModel({
        arabic: "أَنَّ ٱللَّهَ يُعْلِي دَرَجَاتِهِمْ فِي الْجَنَّةِ وَيُكَثِّرُ مَثُوبَاتِهِم وَيُضَاعِفُ حَسَنَاتِهِم ",
        translation:
    ...
    new DhikrModel("", [
      ...
      new DhikrEntryModel({
        ...
        translit: "Wa ilā arwāḥi amwātil muslimīna wa aḥyāhum ilā yawmiddīn, ",
      }),
      new DhikrEntryModel({
