    ...
    entries: [
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            ...
            translit:
              "Aʿūdhu billāhi as-Samīʿ al-ʿAlīm min ash-shayṭān ar-rajīm.",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            ...
            translit:
              "Aʿūdhu bikalimāt Illāhi at-tāmmāti min sharri mā khalaq.",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "ٱللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ عَلَيْكَ تَوَكَّلْتُ وَأَنْتَ رَبُّ ٱلْعَرْشِ ٱلْعَظِيم",
            translit:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "أَعْلَمُ أَنَّ ٱللَّهَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ وَأَنَّ ٱللَّهَ قَدْ أَحَاطَ بِكُلِّ شَيْءٍ عِلْمًا",
            translit:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            ...
            translit:
              "Allāhumma innī asʾaluk al-ʿāfiyata fīd-dunyā wa al-ākhīrah.",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "ٱللَّهُمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذَا ٱلْيَوْمِ فَتْحَهُ وَنَصْرَهُ وَنُورَهُ وَبَرَكَتَهُ وَهُدَاهُ",
            translit:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "سُبْحَٰنَ ٱللَّهِ وَبِحَمْدِهِ عَدَدَ خَلْقِهِ وَرِضَى نَفْسِهِ وَزِنَةَ عَرْشِهِ وَمِدَادَ كَلِمَاتِهِ",
            translit:
