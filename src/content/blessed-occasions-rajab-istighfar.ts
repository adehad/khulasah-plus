...
export default [
  new WirdModel({
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            ...
            translit: "Rabbi ‘ghfir li warhamni wa tub 'alayya.",
            translation:
    ...
    instruction:
      "In Tarim the following formula is read 70 times in congregation immediately after the Isha Prayer every night in Rajab. The one reading it raises their hands while doing so:",
  }),
  new WirdModel({
    ...
    entries: [
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic: "أَسْتَغْفِرُ اللَّهَ ذَا الْجَلَالِ وَالْإِكْرَامِ مِنْ جَمِيعِ الذُّنُوبِ وَالْآثَامِ",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic: "اللَّهُمَّ إِنِّي أَسْتَغْفِرُكَ مِنْ كُلِّ ذَنْبٍ تُبْتُ إِلَيْكَ مِنْهُ ثُمَّ عُدْتُ فِيهِ",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic: "وَأَسْتَغْفِرُكَ لِمَا أَرَدْتُ بِهِ وَجْهَكَ الْكَرِيمَ فَخَالَطَهُ مَا لَيْسَ لَكَ فِيهِ رِضاً",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic: "وَأَسْتَغْفِرُكَ لِمَا وَعَدْتُكَ بِهِ مِنْ نَفْسِي * ثُمَّ أَخْلَفْتُكَ فِيهِ",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "وَأَسْتَغْفِرُكَ لِمَا دَعَانِي إِلَيْهِ الْهَوَى مِنْ قِبَلِ الرُّخَصِ * مِمَّا اشْتَبَهَ عَلَيَّ وَهُوَ عِنْدَكَ حَرَامٌ",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "وَأَسْتَغْفِرُكَ مِنَ النِّعَمِ الَّتِي أَنْعَمْتَ بِهَا عَلَيَّ * فَتَقَوَّيْتُ بِهَا عَلَى مَعْصِيَتِكَ",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "وَأَسْتَغْفِرُكَ مِنْ كُلِّ يَمِينٍ سَلَفَتْ مِنِّي * فَحَنِثْتُ فِيهَا * وَأَنَا عِنْدَكَ مُؤَاخَذٌ بِهَا",
            translit: "",
            translation:
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "وَأَسْتَغْفِرُكَ يَا مَنْ لَا إِلَهَ إِلَّا أَنْتَ وَحْدَكَ لَا شَرِيكَ لَكَ * وَأَنَّ سَيِّدَنَا مُحَمَّدًا عَبْدُكَ وَرَسُولُكَ",
            translit: "",
            translation:
              "I seek Your forgiveness, there is no deity but You, alone without partner, Muhammad is Your slave and messenger.",
          }),
        ],
      }),
      new DhikrModel({
      ...
      new DhikrModel({
        entries: [
          new DhikrEntryModel({
            arabic:
              "وَصَلَّى اللَّهُ تَعَالَى عَلَى سَيِّدِنَا مُحَمَّدٍ وَعَلَى آلِهِ وَصَحْبِهِ وَسَلَّمَ * والْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ * فِي كُلِّ لَحْظَةٍ أَبَدًا * عَدَدَ خَلْقِهِ * وَرِضَاءَ نَفْسِهِ * وَزِنَةَ عَرْشِهِ * وَمِدَادَ كَلِمَاتِهِ",
            translit: "",
            translation:
